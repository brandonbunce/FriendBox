...
void touchscreen_read(lv_indev_t * indev, lv_indev_data_t * data) {
  ...
  if (tft.getTouch(&touchX, &touchY)) {
    ...
    Serial.println(touchX);
      ...
      lv_canvas_set_px(canvas, (TFT_HOR_RES - touchY), touchX, lv_color_hex(0xffff00), LV_OPA_100);
    }
  }
  else {
...
void lv_create_canvas() {
  ...
  lv_scr_load(scr_canvas);
    ...
    LV_DRAW_BUF_DEFINE_STATIC(draw_buf, 30, 30, LV_COLOR_FORMAT_ARGB8888);
  ...
  lv_label_set_text(text_label, "Canvas");
