...
public:
  ...
  {
    {
      ...
      cfg.pin_sclk    = 7;
      cfg.pin_mosi    = 6;   // D6 = LCM_SDI (data into LT7680)
      cfg.pin_miso    = 5;   // D5 = LCM_SDO (data out of LT7680)
...

    {
      ...
      _panel_instance.st7701s_pins.pin_cs  =  9;
      _panel_instance.st7701s_pins.pin_clk = 11;
  ...
  {
    static_cast<lgfx::Panel_PCBA5981 *>(panel())->writeRawFrame(data, w, h);
  }
  void writeRawFrame8bpp(const uint8_t* clut8, uint32_t count)
  {
    static_cast<lgfx::Panel_PCBA5981 *>(panel())->writeRawFrame8bpp(clut8, count);
  }
